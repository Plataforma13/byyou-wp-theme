...
function zm_ajax_login_register_enqueue_scripts(){
    ...
    wp_enqueue_style( 'jquery-ui-custom', "/wp-content/themes/byyou-wp-theme/plugins/zm-ajax-login-register/assets/jquery-ui.css" );

    $styles = apply_filters( ZM_ALR_NAMESPACE . '_styles', array(
        array(
            'handle' => 'ajax-login-register-style',
            'url' => "/wp-content/themes/byyou-wp-theme/plugins/zm-ajax-login-register/assets/style.css"
            )
    ) );
    ...
    $scripts = apply_filters( ZM_ALR_NAMESPACE . '_scripts', array(
        array(
            ...
            'src' => '/wp-content/themes/byyou-wp-theme/plugins/zm-ajax-login-register/assets/scripts.js',
            'deps' => $dependencies
        ),
        array(
            'handle' => 'ajax-login-register-login-script',
            'src' => '/wp-content/themes/byyou-wp-theme/plugins/zm-ajax-login-register/assets/login.js',
            'deps' => $dependencies
        ),
        array(
            'handle' => 'ajax-login-register-register-script',
            'src' => '/wp-content/themes/byyou-wp-theme/plugins/zm-ajax-login-register/assets/register.js',
            'deps' => $dependencies
        )
    ) );
