<?php
	...
	function wp_ulike_enqueue_scripts() {
		...
		// die( plugins_url('assets/js/wp-ulike-plugins.js', dirname('wordpress/wp-content/themes/byyou-wp-theme')));
		// wp_enqueue_script('wp_ulike', plugins_url('assets/js/wp-ulike-scripts.min.js', dirname(__FILE__)), array('jquery'), '1.2.3');
		wp_enqueue_script('wp_ulike', '/wp-content/themes/byyou-wp-theme/plugins/wp-ulike/assets/js/wp-ulike-scripts.min.js', array('jquery'), '1.2.3');
		...
		wp_enqueue_script('wp_ulike_plugins', '/wp-content/themes/byyou-wp-theme/plugins/wp-ulike/', array('jquery'), '1.0.1', true);
		//localize script
	...
	function wp_ulike_enqueue_style() {
		...
		wp_enqueue_style( 'wp-ulike', '/wp-content/themes/byyou-wp-theme/plugins/wp-ulike/assets/css/wp-ulike.css' );
